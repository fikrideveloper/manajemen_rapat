...
@section('title','Edit Kategori Rapat')
...
@section('menu')
    ...
    <li class="breadcrumb-item active">Edit Kategori Rapat</li>
@endsection
...
<section class="section">
    <div class="row">
      <div class="col-lg-11">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Edit Kategori Rapat</h5>

            <!-- General Form Elements -->
            <form action="/update_kategori/{{ $ambil_kategori->id }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Kode Kategori</label>
                <div class="col-sm-10">
                  <input type="text" value="{{ $ambil_kategori->kode_kategori }}" name="kode" class="form-control @error('kode') is-invalid @enderror" autofocus placeholder="Masukkan Kode Kategori"  >
                  @error('kode')
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" value="{{ $ambil_kategori->kategori }}" placeholder="Masukkan Nama Kategori Rapat" class="form-control @error('nama_kategori') is-invalid @enderror" name="nama_kategori" id="">
                  @error('nama_kategori')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
